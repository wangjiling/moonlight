...
config.rss = {
  max_rss_items: "5",
  title: "moonlight",
  description: "The moonlight spirit",
  link: process.env.RSS_LINK || "http://wangjiling.com",
  language: "zh-cn",
  managingEditor: "vincentwangjiling@gmail.com (vincent)",
  webMaster: "vincentwangjiling@gmail.com (vincent)",
  generator: "moonlight",
  author: {
    name: "vincent",
    uri: "http://wangjiling.com"
  }
};
...
//exports.db = mongoskin.db(process.env.MONGOLAB_URI || "mongodb://localhost/moonlight");//数据库连接串
exports.db = mongoskin.db("mongodb://localhost:27017/moonlight", {native_parser:true});
